...
class ColorsManager {
  ...
  static const Color mainYellow= Color(0xFFC7EF00);
  //static const Color  brightYellow= Color(0xFFE4D00A);

  static const Color gray= Color(0xFFB5B3B3);

  static const Color darkGray= Color(0xFF080303);//0xFF171212);
